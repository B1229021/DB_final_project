...
INSERT INTO `announcement` (`id`, `p_id`, `text`) VALUES
(1, 'D1212122', '期中考即將開始，請同學注意時間安排'),
(2, 'D1212124', '期末考報告繳交期限到 6 月 20 日');
...
INSERT INTO `blacklist` (`id`, `p_id`, `s_id`, `text`) VALUES
(1, 'D1212122', 'B1229021', '未依規定時間完成預約'),
(2, 'D1212124', 'B1229051', '多次未出席預約');
...
INSERT INTO `report` (`u_id`, `r_id`, `text`) VALUES
('Ud759801d757d52e40195cffd858b5089', 2, '課表無法正常顯示'),
('Udd68e63026ff651a578c7918ae0b1fd6', 1, '找不到預約按鈕');
